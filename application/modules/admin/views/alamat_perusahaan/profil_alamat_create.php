          ...
          <form method="post" action="<?php echo base_url().$action ?>" enctype="multipart/form-data">
                ...
                <div class="col-sm-10">
                  <input type="hidden" name="id_profil" value="<?php echo $id_profil->id_profil ?>"class="form-control">
						...
						<div class="form-group row">
                <label class="col-sm-2 col-form-label">alamat_perusahaan</label>
                <div class="col-sm-10">
                  <input type="text" name="alamat_perusahaan" class="form-control">
                </div>
              </div>
						<div class="form-group row">
                <label class="col-sm-2 col-form-label">telepon_perusahaan</label>
                <div class="col-sm-10">
                  <input type="text" name="telepon_perusahaan" class="form-control">
                </div>
              </div>
						<div class="form-group row">
                <label class="col-sm-2 col-form-label">email_perusahaan</label>
                <div class="col-sm-10">

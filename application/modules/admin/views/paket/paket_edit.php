            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" name="id_paket" class="form-control" placeholder="" value="<?php echo $dataedit->id_paket?>" readonly>
						...
						<div class="form-group row">
              <label for="example-text-input" class="col-sm-2 col-form-label">nama_paket</label>
              <div class="col-sm-10">
                <input type="text" name="nama_paket" class="form-control" value="<?php echo $dataedit->nama_paket?>">
              </div>
              </div>
						<div class="form-group row">

<?php if($this->session->flashdata('message')) {
             ...
             <div class="col-12">
                 <div class="card">
                     <div class="card-header">
                         <h4 class="card-title">Data profilwebconfig</h4>
      		    		<a href="<?= site_url($module.'/profilwebconfig/create') ?>"><button type="button" class="btn btn-primary round waves-effect waves-light">
      	               	 Tambah Data
      	              	</button>
                      </a>
                     </div>
                         ...
                         <div class="card-body card-dashboard">
                             <div class="table-responsive">
                                 <table class="table crudtable">
                                     ...
                                     <tbody>
                                       <?php foreach ($dataprofilwebconfig as $d): ?>
                                         <tr>
    ...
    <div id="responsive-modal" class="modal fade" tabindex="-1" profilwebconfig="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">

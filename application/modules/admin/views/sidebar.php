<div class="main-menu-content">
            <ul class="navigation navigation-main" id="sidebar" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-zap"></i><span class="menu-title" data-i18n="">Data Master</span></a>
                    <ul class="menu-content">
                        ...
                        <li class=" nav-item"><a href="#"><i class="feather icon-zap"></i><span class="menu-title" data-i18n="">Master Hotel</span></a>
                            <ul class="menu-content">
                        ...
                        <li class="sub-item"><a href="<?= base_url()?>admin/Tipehotel"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="nav.sk_starter_kit.fixed_navigation">Tipe Hotel</span></a>
                        </li>
                        <li class="sub-item"><a href="<?= base_url()?>admin/Subtipehotel"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="nav.sk_starter_kit.fixed_navigation">Sub Tipe Hotel</span></a>
                        </li>
                    </ul>

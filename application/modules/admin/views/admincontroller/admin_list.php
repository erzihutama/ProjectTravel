<?php if($this->session->flashdata('message')) {
                         ...
                         <div class="card-body card-dashboard">
                             <div class="table-responsive">
                                 <table class="table crudtable">
                                     ...
                                     <tbody>
                                       <?php foreach ($dataadmincontroller as $d): ?>
                                         <tr>
                                           <?php foreach ($datafield as $df): ?>
                                             <td><?php echo $d->$df ?></td>
                                           <?php endforeach; ?>
                                           <td>
                                             <a href="<?php echo base_url().$module?>/admincontroller/edit/<?php echo $d->id_user ?>"><i class="m-1 feather icon-edit-2"></i></a>
    ...
    <div id="responsive-modal" class="modal fade" tabindex="-1" admincontroller="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">

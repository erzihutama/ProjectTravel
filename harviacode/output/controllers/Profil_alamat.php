...
class Profil_alamat extends MY_Controller
{
    ...
    public function index()
    {
      ...
      $data = array(
        'contain_view' => '{namamodule}/profil_alamat/profil_alamat_list',
    ...
    public function create(){
      $data = array(
        'contain_view' => '{namamodule}/profil_alamat/profil_alamat_form',
        ...
        'action'=>'{namamodule}/profil_alamat/create_action',
        'module'=>'{namamodule}',
        'titlePage'=>'profil_alamat',
        'controller'=>'profil_alamat'
       );
    ...
    public function edit($id){
      ...
      $data = array(
        'contain_view' => '{namamodule}/profil_alamat/profil_alamat_edit',
        'sidebar'=>'{namamodule}/sidebar',//Ini buat menu yang ditampilkan di module admin {DIKIRIM KE TEMPLATE}
        'css'=>'{namamodule}/crudassets/css',//Ini buat kirim css dari page nya  {DIKIRIM KE TEMPLATE}
        'script'=>'{namamodule}/crudassets/script',//ini buat javascript apa aja yang di load di page {DIKIRIM KE TEMPLATE}
        'action'=>'{namamodule}/profil_alamat/update_action',
        'dataedit'=>$dataedit,
        'module'=>'{namamodule}',
        'titlePage'=>'profil_alamat',
        'controller'=>'profil_alamat'
    ...
    public function create_action()
    {
		...
		'maps' => $this->input->post('maps',TRUE),
            ...
            redirect(site_url('{namamodule}/profil_alamat'));
        }
    }
